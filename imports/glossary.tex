...
\newglossaryentry{Software}{name=Software, description={folgt}, plural=Software}

\newglossaryentry{dropdown}{name=dropdown-Menü, description={folgt}, plural=dropdown Menüs}

\newglossaryentry{Gruppe}{name=Gruppe, description={folgt}, plural=Gruppe}

\newglossaryentry{domain}{name=Domain, description={folgt}, plural=Domains}

\newglossaryentry{MODEL}{name=Domain, description={folgt}, plural=Domains}
