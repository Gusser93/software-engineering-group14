...
\FR{Eine Validierung der Daten ist nicht notwendig.}{003}{A}
...
\FR{Das System soll die Registrierung von Nutzern über eine gültige E-Mail-Adresse, Benutzername und Passwort ermöglichen.}{007}{A}

\FR{Das System soll eine Ansicht zur Benutzerverwaltung beinhalten, über die personenbezogene Daten und Einstellungen geändert werden können. Im Falle des \gls{admin} sollen weitere Konfigurationsoptionen für z.B. nicht registrierte Benutzer zur Verfügung gestellt werden.}{007}{A}

\FR{Das System soll eine Ansicht zur Verwaltung der vom Nutzer hochgeladenen Daten beinhalten. Im Falle des \gls{admin} sollen sämtliche Dateien auf dem Sever verwaltet werden können.}{007/UR008}{A}
...
\FR{The system supports the following
      browsers:\\1. Chrome/Chromium X\\2. Firefox Y.\\ 3. Opera}{018}{A}

\FR{The system supports at least one of the available browsers
      for the following mobile operating systems:\\1. Android
      2.1+\\2. iOS 5.0+\\No additional app (except perhaps browser) is needed.}{018, UR021, UR024}{A}
