...
\FR{Sollten zu viele Uploads gleichzeitig gestartet werden, soll das System diese in einer Warteschlange einordnen.}{003}{A}
...
%8
\FR{Das System soll eine Ansicht zur Verwaltung der vom \gls{Nutzer} hochgeladenen Daten beinhalten. Im Falle des \gls{admin} sollen sämtliche Dateien auf dem Sever verwaltet werden können.}{008}{A}
...
%15
\FR{Die Daten sollen in Tripel abgespeichert werden.}{015}{A}

\FR{Die Datenbank soll lediglich Verweise auf Jar Dateien für die Algorithmen beinhalten.}{015}{A}


%16 
\FR{Mehrere Simulationen müssen gleichzeitig ausgeführt werden können.}{016}{A}
...
%19
\FR{Die Algorithmen sollen in From einer Jar Datei in das System integriert werden.}{019}{A}
...
%20
\FR{Zur besseren globalen Verständigung soll die Systemsprache standardgemäß auf Englisch sein.}{020}{A}

\FR{Die Domain des Server muss weltweit erreichbar sein }{020}{A}
...
\FR{Das System soll ohne spezielle \gls{Software} auf dem Clientrechner auskommen.}{022}{A}

\FR{Sämtliche Daten werden standardgemäß auf dem \gls{server}, nicht auf dem \gls{client} gespeichert.}{022}{A}


%23
\FR{Der \gls{admin} soll über das Einstellungsmenü Usergruppen priorisieren und privilegieren können.}{023}{A}
...
%25
\FR{Die unterstützten Dateiformate eines Modells sollen über eine \gls{Java}-\{api} abgefragt werden können.}{025}{A}
...
\FR{Der Quellcode soll opensource zur Verfügung gestellt werdem.}{026}{A}


%27
\FR{Das System soll ein Hilfemenü mit FAQ behinhalten.}{027}{A}

\FR{Der Software soll ein elektronisches Handbuch zur Verwendung der selbigen beiliegen.}{027}{A}

\FR{Beim ersten Login eines \gls{Nutzer} soll dieser durch ein kurzes Tutorial in die Bedienung der Software eingeführt werden.}{027}{B}

%28
\FR{Die Lizenzinformationen eines Models sollen mit diesem in der Datenbank abgespeichert werden.}{028}{A}
...
%29
\FR{Das System sowie der zugehörige Quellcode soll für jeden frei zugänglich sein.}{029}{A}
...
\FR{Zu jedem Algorithmus wird der Uploader mit angegeben, falls der \gls{admin} diesen \gls{Nutzer} kontaktieren muss.}{032}{A}
...
\FR{Planmäßig soll sich das System automatisch einmal im Monat sichern. Sollte bei diesem Prozess ein Fehler auftreten, soll der \gls{admin} via E-Mail informiert werden.}{034}{A}

%35
\FR{Das System soll variable genug programmiert sein um mögliche weitere Sprachen hinzuzufügen.}{035}{A}
